    ...
    <div class="SIMSearch">
        <el-form :inline="true" :model="searchModel" ref="searchModel" class="demo-form-inline">
            <el-form-item label="卡号" prop="number">
                <el-autocomplete popper-class="my-autocomplete" v-model="numberSearch" :fetch-suggestions="querySearch" placeholder="卡号">
            ...
            <el-form-item label="尺寸" prop="size">
                <el-select v-model="searchModel.size" placeholder="尺寸">
            ...
            <el-form-item label="运营商" prop="operator">
                <el-select v-model="searchModel.operator" placeholder="运营商">
...
<script>
    export default {
        ...
        methods: {
            onSubmit(formName) {
                this.searchModel.number = this.numberSearch
