<template>
    <div class="SIMTable">
        <el-table :data="tableData" stripe header-row-class-name="tableHeader" empty-text="暂时没有数据" border
            style="width: 100%">
            <el-table-column prop="bookname" label="书名" align="center" width="100">
            </el-table-column>
            <el-table-column prop="author" label="作者" align="center" width="100">
            </el-table-column>
            <el-table-column prop="publish" label="出版社" align="center" width="100">
            </el-table-column>
        ...
        <el-dialog title="书籍详情" :visible.sync="detailVisible" width="70%">
            <book-detail :gridtable="phonedetail"></book-detail>
        </el-dialog>
    </div>
</template>

<script>
    import BookDetail from '@/base/book/bookDetail'
    export default {
        name: 'SIMTable',
        created() {
